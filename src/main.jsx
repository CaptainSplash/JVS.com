...
>
  ...
  Last updated 15/06/2025
    ...
    <div style={{ 
      ...
      <span style={{ display: 'inline-block', position: 'relative', paddingBottom: '0.05em' }}>
        <a
          href="/JVS%20PDF%20Portfolio.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="footer-link"
          style={{
            display: 'inline-block',
            paddingBottom: '0.05em',
            color: 'inherit',           // Ensures it inherits white from parent
    ...
    <div style={{ 
      ...
      {showContactFooter && (        <form
        ...
        >
          {/* Honeypot field to catch bots */}
          <div style={{ opacity: 0, position: 'absolute', top: 0, left: 0, height: 0, width: 0, zIndex: -1 }}>
            <label htmlFor="bot-field-3">Don't fill this out if you're human:</label>
            <input name="bot-field" id="bot-field-3" />
          </div>
          <input
            name="email"
            type="email"
